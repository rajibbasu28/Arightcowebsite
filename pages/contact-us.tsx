  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col lg:flex-row min-[1350px]:mx-28">
        ...
        >
          ...
          <IconGroup
            ...
            title={"Visit Us"}
            text={[
              "US office: 84 W Santa Clara St Suite 700, Mailbox #92 San Jose, CA 95113, United States",
      ...
      <div className="text-xl md:text-2xl text-blue font-bold mx-5 xl:mx-32 mt-20">
        ...
        >
          US: 84 W Santa Clara St Suite 700, Mailbox #92 San Jose, CA 95113, United States
        </Link>
      </div>
